...
//     const img = document.createElement('img');
//     img.src = item.src || 'default-image.png'; // Default image if none provided
//     img.alt = item.title;
//     itemCard.appendChild(img);
...
export class profilePage extends BaseComponent {
  #container = null;
//   #headerSection = null; // New header section
//   #userInfoSection = null;
//   #itemsGrid = null;
//   #editProfileButton = null;
//   #addNewItemButton = null;
  ...
  render() {
    ...
    // Create and append sections
    // this.#container.appendChild(this.#createHeaderSection()); // Add header section
    // this.#container.appendChild(this.#createItemsGrid());
  ...
  // New method to create the header section
//   #createHeaderSection() {
//     this.#headerSection = document.createElement('div');
//     this.#headerSection.className = 'header-section';

//     // User info section
//     this.#headerSection.appendChild(this.#createUserInfoSection());

//     // Buttons section
//     this.#headerSection.appendChild(this.#createButtonsSection());
